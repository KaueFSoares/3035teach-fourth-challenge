...
const ProfilePage = () => {
  ...
  return (
    <main className="w-full min-h-screen h-screen bg-gray/[.5] flex flex-col items-center justify-start ">
      {(profile && repos) ? (
        <>
          <Header />
          <div className="w-[95%] h-[100%] bg-white box-border shadow-sm rounded-xl my-4 md:my-6">
            <section className="p-5 lg:p-8 mb-8">
